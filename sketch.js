...
var player, playerImage, enemy, enemyAnimation;

function preload()
{
  enemyAnimation = loadAnimation("Images/Enemy1.png","Images/Enemy2.png","Images/Enemy3.png","Images/Enemy4.png",
  "Images/Enemy5.png","Images/Enemy6.png","Images/Enemy7.png","Images/Enemy8.png","Images/Enemy9.png","Images/Enemy10.png")

  oenemyAnimation = loadAnimation("Images/Mirrored/oEnemy1.png","Images/Mirrored/oEnemy2.png","Images/Mirrored/oEnemy3.png","Images/Mirrored/oEnemy4.png",
  "Images/Mirrored/oEnemy5.png","Images/Mirrored/oEnemy6.png","Images/Mirrored/oEnemy7.png","Images/Mirrored/oEnemy8.png","Images/Mirrored/oEnemy9.png","Images/Mirrored/oEnemy10.png")
...
function setup() {
  ...
  enemy1.addAnimation("enemy",enemyAnimation);
  enemy1.scale=0.5 
